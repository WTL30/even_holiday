      ...
      <section className="bg-teal-700 text-white py-16">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl font-light mb-6" style={{ fontFamily: 'Georgia, serif' }}>
              Contact Us
            </h1>
            <p className="text-xl text-teal-100 max-w-3xl mx-auto">
              Have questions about our timeshare offerings? Fill out the form below and our specialist will get back to you shortly.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-light text-gray-900 mb-8 text-center" style={{ fontFamily: 'Georgia, serif' }}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@a1holiday.com</p>
                      <p className="text-gray-600">support@a1holiday.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Timeshare Avenue</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gray-200 rounded-2xl overflow-hidden shadow-lg" style={{ height: '450px' }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.9385479856346!2d72.8776559!3d19.0759837!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c63aceef0c69%3A0x2aa80cf2287dfa3b!2sJogeshwari%20Mumbai!5e0!3m2!1sen!2sin!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="A1 Holiday Company Location"
              />
            </div>
          </div>
        </div>
